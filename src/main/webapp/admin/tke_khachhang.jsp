                                    ...
                                    <table id="zero_config" class="table table-striped table-bordered no-wrap">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="width:50px">Tổng tiền thanh toán</th>
                                                <!-- <th>Tác Vụ</th> -->
                                            </tr>
                                        </thead>
                                        <tbody>
                                        <c:forEach var="listkh" items = "${datakh}" >
                                            <tr>
                                                ...
                                                <td>${listkh.tongtien}</td>
                                               <!--  
                                                <td>
                                                    <a class="btn waves-effect waves-light btn-info" href="thanhtoanServlet?id=${listkh.id_khachhang}">Thanh toán</a>
